...
namespace vinabb\kidtoons\exceptions;
...
class base extends \Exception
{
	...
	*/
	protected function translate_portions(\phpbb\language\language $language, $message_portions, $parent_message = null)
	{
		// Make sure our language file has been loaded
		$this->add_lang($language);
		...
		foreach ($message_portions as &$message)
		{
			...
			$translated_message = $language->lang('EXCEPTION_' . $message);
	...
	* @return void
	*/
	public function add_lang(\phpbb\language\language $language)
	{
		...
		// Add our language file
		$language->add_lang('exceptions', 'vinabb/web');
