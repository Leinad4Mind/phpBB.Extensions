...
// see https://github.com/Modernizr/Modernizr/blob/master/feature-detects/storage/localstorage.js
    ...
    function init(self, source, options) {
        ...
        .on("@bbcodebtn.click", function(bbcodebtn) {
            ...
            if (self.standalone) {
                editor.html(bbcodebtn.data('bbcode-tag-open') + text + bbcodebtn.data('bbcode-tag-close'));
                self.trigger("blur");
            } else {
                saveSelection(editor[0]);
                pasteHtmlAtCaret(bbcodebtn.data('bbcode-tag-open') + text + bbcodebtn.data('bbcode-tag-close'));
            }
        ...
        .on("@smileybtn.click", function(smileybtn) {
            ...
            if (self.standalone) {
                editor.html(' ' + smileybtn.data('smiley-code') + ' ');
                self.trigger("blur");
            } else {
                saveSelection(editor[0]);
